...
<div class="row" id="divForma2">
    <div class="small-12 medium-12 large-12 xlarge-12 columns">
        <span class="label" style="width: 100%; margin-top: 20px; margin-bottom: 30px"><h4 class="text-center" style="color:white">Statistika bolesti po životinjskoj vrsti i vremenskom periodu</h4></span> 
    </div>
</div>   
<div class="row"> 
            <div class="small-12 medium-7 medium-centered large-7 large-centered xlarge-7 large-centered columns">
                <form method="POST" action={$skripta}  data-abide>
                    ...
                    <div>
                         <label  for="ziv">Ambulanta</label>
                        <select  name="ziv" required>
                            {$ispis2}
                        </select>
                        <small class="error">Obavezno odaberite životinjsku vrstu.</small>
                    </div>
                    <br> 
