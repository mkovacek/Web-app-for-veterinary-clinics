...
<div class="row" id="divForma2">
    <div class="small-12 medium-12 large-12 xlarge-12 columns">
        <span class="label" style="width: 100%; margin-top: 20px; margin-bottom: 30px"><h4 class="text-center" style="color:white">Statistika termina po životinjskoj vrsti i vremenskom periodu</h4></span> 
    </div>
</div>   
<div class="row"> 
